      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-stretch mb-16 sm:mb-24">
          ...
          >
            <div className="border-l-4 border-[#C8A400] pl-5 mb-6">
              <h2 className="text-2xl font-bold text-[#7B1C2E]">Our School</h2>
            </div>
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-2xl overflow-hidden shadow-2xl border-4 border-[#FDF9EC] h-[280px] sm:h-[360px]"
          >
            {!campusFailed ? (
              <img
                src={campusImageUrl}
        ...
        >
          ...
          <div className="text-center mb-10">
            <h2 className="text-3xl font-extrabold text-[#7B1C2E] mb-2">Principal's Message</h2>
            <div className="w-16 h-1 bg-[#7B1C2E] mx-auto rounded-full" />
          </div>
              ...
              <div className="flex flex-col items-center justify-center bg-[#7B1C2E] p-8 md:p-10">
                ...
                <div className="w-40 h-40 md:w-48 md:h-48 rounded-full overflow-hidden border-4 border-[#7B1C2E] shadow-xl mb-5">
                  {!principalFailed ? (
                    ...
                    <div className="w-full h-full flex items-center justify-center bg-[#7B1C2E]">
                ...
                {/* Decorative divider */}
                <div className="w-10 h-0.5 bg-[#7B1C2E] mt-4 rounded-full opacity-60" />
              </div>
