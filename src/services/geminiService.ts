...
- Departmental Heads: Mr S Mgedezi (Languages - English), Miss Dandala RN (Languages - IsiXhosa), NC Jovula (Humanities FET), Ms B Mgilane (Humanities GET), N. Jiba (BCM), Ms A Dinga (Agric, NS and Life Sciences), Mr Mnoneleli Njubane (Maths and Technology)
- Class teachers: Mr Mdingi A (Mathematics; Grade 10A), Miss Ndzelu (Economics; Grade 11B), Ms N Reid-Magongo (IsiXhosa; Grade 11C), Mr M Lakhithika (Life Orientation, IsiXhosa HL, Technology; Grade 12A), Miss A. Nqatsha (English FAL Grade 10, Business Studies Grade 12; Grade 12C), Mr M Nozulela (History and Technology; Grade 9A), Ms G. Jojo (English Grade 9, Life Orientation Grade 10; Grade 9B), Mrs N Kafu (English Grade 8, Life Orientation Grade 11; Grade 8A), Mrs T. Mkubukeli (English, Life Orientation, Creative Arts; Grade 8B)
