...
- Deputy Principals: Mr B. Mamfengu (Physical Sciences, Grades 10 & 12), Mr R. K Qangule (Mathematics) — both also Subject Teachers
- Departmental Heads: Mr S Mgedezi (Languages), NC Jovula (Humanities FET), Ms B Mgilane (Humanities GET), N. Jiba (BCM), Ms A Dinga (Agric, NS and Life Sciences), Mr Mnoneleli Njubane (Maths and Technology)
