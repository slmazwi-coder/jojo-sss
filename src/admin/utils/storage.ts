...
const defaultContact: ContactInfo = {
  address: 'Lukholweni Location, Matatiele, 4730 (Eastern Cape)',
  phone: '066 203 0097',
...
const defaultAbout: AboutInfo = {
  historyParagraphs: [
    'Ludidi Senior Secondary School is a public boarding school serving learners in and around Sigoga Location (Matatiele, Eastern Cape).',
  ...
  principalMessage: [
    'Welcome to Ludidi Senior Secondary School. We believe every learner can achieve with consistent effort, good support, and a strong learning environment.',
